    ...
    <>
      <header className={`heading-heading ${props.rootClassName} `}>
        <header data-thq="thq-navbar" className="heading-navbar-interactive">
          ...
          <div data-thq="thq-mobile-menu" className="heading-mobile-menu">
            ...
            <div>
              <svg viewBox="0 0 950.8571428571428 1024" className="heading-icon14">
              ...
              <svg viewBox="0 0 877.7142857142857 1024" className="heading-icon16">
              ...
              <svg viewBox="0 0 602.2582857142856 1024" className="heading-icon18">
      ...
      <style jsx>{`
        ...
        @media (max-width: 479px) {
          ...
          .heading-mobile-menu { padding: 16px; }
          .heading-logo { width: var(--dl-layout-size-large); height: auto; }
        }
      `}</style>
    </>
  )
