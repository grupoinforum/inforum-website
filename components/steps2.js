            ...
            <div className="steps2-container3">
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        Schedule a meeting with our team to discuss your web
                        design and digital transformation needs.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        Receive a personalized proposal outlining the
                        recommended solutions tailored to your business
                        requirements.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text30">
                        Our team, led by CEO Edgar Urrutia, will execute the
                        project ensuring a successful implementation.
                      </span>
                    </Fragment>
                  )}
                </span>
              ...
              <div className="steps2-container7 thq-card">
                <h2 className="thq-heading-2">
                  {props.step4Title ?? (
                    <Fragment>
                      <span className="steps2-text25">Ongoing Support</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text29">
                        Benefit from continuous support and maintenance services
                        to keep your digital solutions running smoothly.
                      </span>
                    </Fragment>
                  )}
                </span>
