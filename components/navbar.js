      ...
      <header className={`navbar-navbar ${props.rootClassName} `}>
        <div className="navbar-desktop">
          ...
          <div className="navbar-quick-actions">
            <Link href="/">
              <a className="link navbar-link18">Log in</a>
            </Link>
            <Link href="/">
              <a className="navbar-link19">
        ...
        <div id="mobile-menu" className="navbar-mobile">
          ...
          <div className="navbar-links2">
            <Link href="/">
              <a className="navbar-link20">{props.text1}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link21">{props.text11}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link22">{props.text12}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link23">{props.text13}</a>
            </Link>
