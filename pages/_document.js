...
export default function Document() {
  return (
    <Html lang="es">
      <Head>
        {/* OJO: el meta viewport ya no va aquí (lo movimos a _app.js) */}
        <meta charSet="utf-8" />
        <meta property="twitter:card" content="summary_large_image" />

        {/* Resets/base que venían de Teleport */}
        <style
        ...
        />
        {/* Eliminado el bloque <noscript> con Tailwind CDN de preview */}
      </Head>
      <body>
        <Main />
        <NextScript />
        {/* Script de Teleport (si lo usas para acordeones/efectos) */}
